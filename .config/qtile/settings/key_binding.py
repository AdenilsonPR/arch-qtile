...
keys = [
    ...
    Key([super], "space", lazy.spawn(application_launcher), desc="Spawn a command using a prompt widget"),
    Key([alt], "tab", lazy.spawn(active_windows), desc="Spawn a command using a prompt widget"),
